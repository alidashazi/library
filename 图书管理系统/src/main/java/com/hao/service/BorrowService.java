...
public interface BorrowService {
    ...
    //用户根据归还图书名找对应的借书记录
    List<Borrowbook> selectUserByReturnBookName(String bookName,String borrowName);
    //用户根据未归还图书名找对应的借书记录
    List<Borrowbook> selectUserByBorrowBookName(String bookName,String borrowName);
}
