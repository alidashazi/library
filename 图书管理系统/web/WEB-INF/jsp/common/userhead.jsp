...
<section class="publicMian ">
    <div class="left">
        ...
        <nav>
            <ul class="list">
                <li><a href="${pageContext.request.contextPath }/user/tobooklist">书籍列表</a></li>
                <li><a href="${pageContext.request.contextPath }/user/toborrowbooklist">借阅列表</a></li>
                <li><a href="${pageContext.request.contextPath }/user/toupdatepassword">密码修改</a></li>
                <li><a href="${pageContext.request.contextPath }/user/touserinfo">用户个人信息</a></li>
